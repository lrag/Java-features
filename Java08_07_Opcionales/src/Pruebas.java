...
public class Pruebas {
	...
	public static void main(String[] args) {
		...
		//Con optional como mínimo avisamos al que invoca al mÃ©todo de que puede recibir un null
		...
		System.out.println(titulo); //Esto será siempre nulo: TJ
